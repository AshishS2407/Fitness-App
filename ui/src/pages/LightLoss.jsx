...
const LightLoss = () => {
    ...
    useEffect(() => {
      ...
      const handleWorkoutClick = () => navigate('/workouts/light-weight-loss');
      const handleDietClick = () => navigate('/lightlossdietplans');
      const handleArticlesClick = () => navigate('/lightlossarticles');
