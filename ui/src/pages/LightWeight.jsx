...
const LightWeight = () => {
        ...
        useEffect(() => {
          ...
          const handleGainingWeightClick = () => {
            navigate('/lightweight-gain'); // Replace with the actual URL for gaining weight features
          };
      
          const handleReducingWeightClick = () => {
            navigate('/lightweight-loss'); // Replace with the actual URL for reducing weight features
          };
