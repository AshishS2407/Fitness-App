    ...
    useEffect(() => {
      ...
      if (workoutBtn) {
        workoutBtn.addEventListener('click', () => {
          navigate('/workouts/medium-weight-gain');
        });
      }
  
      if (dietBtn) {
        dietBtn.addEventListener('click', () => {
          navigate('/mediumgaindietplans');
        });
      }
  
      if (articlesBtn) {
        articlesBtn.addEventListener('click', () => {
          navigate('/mediumgainarticles');
        });
      }
      ...
      return () => {
        if (workoutBtn) {
          workoutBtn.removeEventListener('click', () => {
            navigate('/workout');
          });
        }
        if (dietBtn) {
          dietBtn.removeEventListener('click', () => {
            navigate('/diet');
          });
        }
        if (articlesBtn) {
          articlesBtn.removeEventListener('click', () => {
            navigate('/articles');
          });
        }
      };
