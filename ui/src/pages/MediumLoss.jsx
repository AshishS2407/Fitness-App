...
const MediumLoss = () => {
  ...
  useEffect(() => {
    ...
    const handleWorkoutClick = () => navigate('/workouts/medium-weight-loss');
    const handleDietClick = () => navigate('/mediumlossdietplans');
    const handleArticlesClick = () => navigate('/mediumlossarticles');
