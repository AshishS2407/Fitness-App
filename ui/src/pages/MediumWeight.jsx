...
const MediumWeight = () => {
  ...
  useEffect(() => {
    ...
    const handleGainingWeightClick = () => {
      navigate('/mediumweight-gain'); // Redirects to the gaining weight features page
    };

    const handleReducingWeightClick = () => {
      navigate('/mediumweight-loss'); // Redirects to the reducing weight features page
    };
  ...
  return (
    ...
    <div class="flex justify-evenly p-40">
        <div
            class="w-[400px] h-[600px] rounded-md shadow-xl shadow-grey-100 bg-gradient-to-r from-cyan-500 to-blue-500">
            <div class="mt-40"> <br/> <br/> <br/>
                ...
                <button id="gainingWeightBtn"
                    class="bg-white hover:bg-cyan-100 border rounded-md p-2 shadow-xl text-blue-500 font-semibold ml-40">View
                    More</button>
            </div>
        </div>
