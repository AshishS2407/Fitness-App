...
const LightWeightGainVideosPage = ({ userType }) => { // Accept userType as a prop
    const [videos, setVideos] = useState([]);

    useEffect(() => {
        const fetchVideosByCategory = async () => {
            try {
                const response = await axios.get('http://localhost:5000/workouts?category=light weight gain');
    ...
    return (
        <>
            <div className="bg-black">
                ...
                {userType === 'user' && (
                    <div className="bg-gradient-to-r from-green-500 to--500 w-[200px] h-16 rounded-md mx-auto p-4 mt-20">
...
export default LightWeightGainVideosPage;
