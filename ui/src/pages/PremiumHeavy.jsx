...
const PremiumHeavy = () => {
    ...
    useEffect(() => {
        ...
        const handleWorkoutClick = () => navigate('/premium/workouts/heavy-weight-loss');
        const handleDietClick = () => navigate('/premium/heavyweight-loss-dietplans');
        const handleArticlesClick = () => navigate('/premium/heavyweight-loss-articles');
                ...
                <div class="flex justify-between p-40">
                    ...
                    <div class="w-[400px] h-[600px] rounded-md shadow-xl shadow-grey-100 bg-gradient-to-r from-green-400 to-blue-500">
                        <div class="mt-40">
                            ...
                            <br /><br /><br />
                            <button id="dietBtn" class="bg-white hover:bg-cyan-100 border rounded-md p-2 shadow-xl text-blue-500 font-semibold ml-40">View More</button>
                        </div>
                    </div>
                    ...
                    <div class="w-[400px] h-[600px] rounded-md shadow-xl shadow-grey-100 bg-gradient-to-r from-green-400 to-blue-500">
                        <div class="mt-40">
                            ...
                            <br /><br /><br />
                            <button id="articlesBtn" class="bg-white hover:bg-cyan-100 border rounded-md p-2 shadow-xl text-blue-500 font-semibold ml-40">View More</button>
                        </div>
                    </div>
                </div>
            </div>
