    ...
    const navigate = useNavigate();
        ...
        useEffect(() => {
          ...
          const handleGainingWeightClick = () => {
            navigate('/premium/mediumweight-gain'); // Replace with the actual URL for gaining weight features
          };
      
          const handleReducingWeightClick = () => {
            navigate('/premium/mediumweight-loss'); // Replace with the actual URL for reducing weight features
          };
